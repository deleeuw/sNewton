...
```{r equissmacof, cache = FALSE, eval = FALSE}
...
```{r morse ssmacof, cache= FALSE, eval = FALSE}
...
```{r gruijterssmacof, cache = FALSE, eval = FALSE}
...
```{r file_auxilary4, code = readLines("msmacof.R")}
```

## vsmacof.R

```{r file_auxilary5, code = readLines("vsmacof.R")}
```

## ssmacof.R

```{r file_auxilary6, code = readLines("ssmacof.R")}
```
